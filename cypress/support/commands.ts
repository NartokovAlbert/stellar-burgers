...
Cypress.Commands.add('validateOrderAndCloseModal', () => {
  cy.wait('@postOrder').then(() => {
    cy.get('@postOrder')
      ...
      .should('deep.equal', ['643d69a5c3f7b9001cfa093c','643d69a5c3f7b9001cfa0940', '643d69a5c3f7b9001cfa0947', '643d69a5c3f7b9001cfa0946', '643d69a5c3f7b9001cfa0948', '643d69a5c3f7b9001cfa0949', '643d69a5c3f7b9001cfa094a', '643d69a5c3f7b9001cfa094a', '643d69a5c3f7b9001cfa094a', '643d69a5c3f7b9001cfa0942', '643d69a5c3f7b9001cfa0943', '643d69a5c3f7b9001cfa093c']);
...
Cypress.Commands.overwrite('visit', (originalFn, url, options) => {
  originalFn(url, { ...options, onBeforeLoad: win => {
    win.localStorage.setItem('refreshToken', JSON.stringify('testRefreshToken'));
